											...
											<tbody class="formFields andswhite" style="font-size:1.4em;"> 
												...
												<tr>
													...
													<td onclick="getHelpText('collection_location_physical_address_part_type');" style="vertical-align:middle; width:270px;">
														...
														<textarea id="object_location_%%SEQNUM1%%_address_%%SEQNUM2%%_physical_%%SEQNUM3%%_addressPart_%%SEQNUM4%%_value" name="object.location[%%SEQNUM1%%].address[%%SEQNUM2%%].physical[%%SEQNUM3%%].addressPart[%%SEQNUM4%%].value"  class="ckeditor_text"></textarea>
						...
						<tbody>
							...
							<tr>
								<td class="formNotes" id="rmb_formNotes">
									...
									Data captured through this system will be validated against the <a class="colorGrey" target="_blank" href="http://ands.org.au/resource/rif-cs.html">RIF-CS 1.2.0 Schema</a> and <a class="colorGrey" target="_blank" href="http://ands.org.au/resource/metadata-content-requirements.html">Metadata Content Requirements</a>.<br />
								</td>
							</tr>
						</tbody>
					</table>	
