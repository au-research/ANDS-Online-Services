...
if( $registryObject )
{
	...
	if(isContributorPage($registryObjectKey)) {
		...
		$rdaLink = '<br /><a style="font-size:0.8em; font-weight: normal;" href="'.$default_protocol.'://'.$host.'/'.$rda_root . '/' . $url_slug.'">'.$rdaLinkPrefix.' this record in Research Data Australia</a>'."\n";
	}
