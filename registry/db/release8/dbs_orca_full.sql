...
-- Created: 29/06/2012 (ben.greenwood@ands.org.au)
...
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE dba.tbl_institution_pages TO webuser;
...
INSERT INTO tbl_vocabularies (identifier, identifier_type, version, name, name_type, description, source) VALUES ('RIFCSLicenceType', 'local', '1.3','RIFCS Licence Type', 'primary', '', 'http://services.ands.org.au/documentation/rifcs/1.3.0/vocabs/vocabularies.html');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('CC-BY', 'local','CC-BY', 'CC-BY licence type','RIFCSLicenceType','Open Licence','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('CC-BY-SA', 'local','CC-BY-SA', 'CC-BY-SA licence type','RIFCSLicenceType','Open Licence','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('GPL', 'local','GPL', 'GPL licence type','RIFCSLicenceType','Open Licence','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('CC-BY-NC', 'local','CC-BY-NC', 'CC-BY-NC licence type','RIFCSLicenceType','Non-Commercial Licence','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('CC-BY-NC-SA', 'local','CC-BY-NC-NA', 'CC-BY-NC-NA licence type','RIFCSLicenceType','Non-Commercial Licence','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('CC-BY-ND', 'local','CC-BY-ND', 'CC-BY-ND licence type','RIFCSLicenceType','Non-Derivative Licence','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('CC-BY-NC-ND', 'local','CC-BY-NC-ND', 'CC-BY-NC-ND licence type','RIFCSLicenceType','Non-Derivative Licence','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('AusGOALRestrictive', 'local','AusGOALRestrictive', 'AusGOALRestrictive licence type','RIFCSLicenceType','Restrictive Licence','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('NoLicence', 'local','NoLicence', 'NoLicence licence type','RIFCSLicenceType','No Licence','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('Unknown/Other', 'local','Unknown/Other', 'Unknown/Other licence type','RIFCSLicenceType','Unknown','pt','RIFCS Licence Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('researchAreas', 'local','researchAreas', 'Contributor research areas','RIFCSDescriptionType','','pt','RIFCS Description Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('researchDataProflie', 'local','researchDataProflie', 'Contributor research data profile','RIFCSDescriptionType','','pt','RIFCS Description Type');
INSERT INTO tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('researchSupport', 'local','researchSupport', 'Contributor research support','RIFCSDescriptionType','','pt','RIFCS Description Type');
