...
INSERT INTO dba.tbl_terms (identifier, identifier_type, name, description, vocabulary_identifier, parent_term_identifier,type,vocabpath) VALUES ('researchArea', 'local','researchArea', 'Contributor research area','RIFCSDescriptionType','','pt','RIFCS Description Type');
