...
/**
 * This harvest is temporary and should ultimately replace the
 * GeoPMHRIFHarvestThread.
 * 
 * This harvest takes RIF-CS generated from a GeoNetworks site and
 * collates party information.
 * 
 * <p>This harvest:
 ...
 */
public class GeoPMHRIFHarvestThread2 extends HarvestThread
{
    private final Logger log = Logger.getLogger(GeoPMHRIFHarvestThread2.class);
     ...
     */
    public GeoPMHRIFHarvestThread2()
    {
    ...
    public void run()
    {
        try
        {
            ...
            while (listRecords != null)
            {
                ...
                NodeList ros = doc.getElementsByTagName("registryObject");
                ...
                Fragment frag = getFragment(docToString(rifcs), "ListRecords");
