	...
	$.ajax({
		...
		success: function(data){
			...
			$('.checkbox_view1').each(function(){
				...
				$(this).html('<span class="label label-info"><i class="icon icon-ok"></i> On </span> '+ '&nbsp;' + whatsThere);
			});
			...
			$('.checkbox_view0').each(function(){
				var whatsThere = $(this).html();
				$(this).html('<span class="label label-info"><i class="icon icon-remove"></i> Off </span> ' + '&nbsp; ' + whatsThere);
			});
