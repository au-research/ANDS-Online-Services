...
<div class="container less_padding">
	...
	<p>You may be able to locate similar records by searching for the record by title: 
		<a href="<?=base_url() . "search#!/q=" . rawurlencode($previously_valid_title);?>/p=1/tab=All/nq=1/"><?=$previously_valid_title;?></a></p>
</div>
