/**
 * Date Modified: $Date: 2010-03-01 14:47:05 +1100 (Mon, 01 Mar 2010) $
 ...
 * 
 * <p><strong>Service: addValue</strong>
...
{
    private final Logger log = Logger.getLogger(AddValueServlet.class);
                  ...
                  final HttpServletResponse response) throws ServletException
    {
        ...
        try
        {
            ...
            if (value == null || type == null || handleString == null)
            {
                ServletSupport.doErrorResponse(response, "Handle, type and value must be specified", Constants.MESSAGE_TYPE_USER);
                return;
            }

            if (handleString.trim().equals("") || type.trim().equals("") || value.trim().equals("")) 
            {
            ...
            boolean added = handle.addValue(HandleSupport.createHandleValue(type, value, -1));
