...
public class Collection extends RIFCSElement
{
    ...
    /**
     * Set the date the collection metadata was recorded in the system
     * from which the RIF-CS is being constructed
     * 
     * @param date
     ...
     * 
     * @return 
     *      The dateAccessioned attribute value or empty string if attribute
     *      is empty or not present
     */  
    ...
    public void addSubject(String subject,
                           String type,
                           String language) throws RIFCSException
    {
    ...
    /**
     * Convenience method to add related info to the collection object 
     * 
